...
if (isset($_SESSION['nama'])) {
    $sql = "SELECT * FROM t_responden_mhs WHERE id_kategori = 2 AND responden_nama = '" . $_SESSION['nama'] . "'" ;
...
$sql = "SELECT s.id_soal, s.id_survey id_survey, k.kategori_nama, k.id_kategori id_kategori, soal_nama FROM m_survey_soal s LEFT JOIN m_kategori k ON s.id_kategori = k.id_kategori WHERE s.id_kategori = 2 && s.id_survey = 1;";
$result = mysqli_query($connect,$sql);
?>
...
<body>
    ...
    <div class="grid grid-cols-5 h-screen">
        ...
        <h1 class="text-6xl font-bold mb-6">Penilaian Dosen</h1>
