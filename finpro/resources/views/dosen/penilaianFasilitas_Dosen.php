...
if (isset($_SESSION['nama'])) {
    $sql = "SELECT * FROM t_responden_dosen WHERE id_kategori = 1 AND responden_nama = '" . $_SESSION['nama'] . "'";
...
$sql = "SELECT s.id_soal, s.id_survey id_survey, k.kategori_nama, k.id_kategori id_kategori, soal_nama FROM m_survey_soal s LEFT JOIN m_kategori k ON s.id_kategori = k.id_kategori WHERE s.id_kategori = 1 && s.id_survey = 2;";
$result = mysqli_query($connect,$sql);
?>
        ...
        <div class="col-span-4">
            <main class="col-span-4">
                <div class="bg-white p-8 rounded-xl shadow-md">
                    ...
                    <form action="submitProses_Dosen.php" method="post">
                        <div class="grid gap-4 col-span-4">
                            ...
                            <div>
                                <div class="flex justify-between w-full">
                                    <button class="bg-white text-[#2D1B6B] border-[#2D1B6B] py-2 px-4 rounded-xl border-[#2D1B6B] border-4" type="back"><a href="surveyDosen.php"><b>Survey Page</b></a></button>
