...
$sql = "SELECT s.id_soal, s.id_survey id_survey, k.kategori_nama, k.id_kategori id_kategori, soal_nama FROM m_survey_soal s LEFT JOIN m_kategori k ON s.id_kategori = k.id_kategori WHERE s.id_kategori = 4 && s.id_survey = 2;";
$result = mysqli_query($connect,$sql);
?>
...
<body>
    ...
    <div class="grid grid-cols-5 h-screen">
        ...
        <form action = "submitProses_Dosen.php" method= "post"> <!--CHECK FILE LG-->
