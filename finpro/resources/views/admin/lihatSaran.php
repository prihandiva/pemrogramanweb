...
<body>
    ...
    <div class="grid grid-cols-5 h-screen">
        ...
        <div class="col-span-4">
            <h1 class="text-4xl font-bold mb-6 mt-8 px-6">Hasil Kotak Saran</h1>
        ...
        <div>
            <table class="border-collapse table-auto w-full text-sm mb-2">
                <thead>
                    <tr>
                        <th class="text-left mb-4">Nama</th>
                        <th class="text-left mb-4">Posisi</th>
                        <th class="text-left mb-4">Lihat Saran</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="end-content bg-[#2D1B6B] border-[#2D1B6B] text-white py-2 px-4 rounded-xl border-4"><a href="kotakSaran.php?responden_nama=<?= $row['responden_nama']?>">Lihat</a></button>
                        </td>
                        </tr>
                    <?php
                        }
