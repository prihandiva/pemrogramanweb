    ...
    <div class="grid grid-cols-5 h-screen w-full">
        ...
        <div class="col-span-4">
            ...
            <ul class="grid grid-rows-3 gap-3 text-sm  px-10">
                ...
                <!--FASILITAS-->
                <a class="w-full" href="editSurvey_pilihSoal.php?id_kategori=1" > 
                    <li class="flex items-center justify-start gap-4 w-full px-5 py-2 bg-[#2D1B6B] font-bold text-white rounded-xl">
                        ...
                        <div>
                            <!--KIRIM id_kategori bisa kaga ya-->
                ...
                <!--DOSEN-->
                <a class="w-full" href="editSurvey_pilihSoal.php?id_kategori=2">
                    <li class="flex items-center justify-start gap-4 w-full px-5 py-2 bg-[#2D1B6B] font-bold text-white rounded-xl">
                ...
                <!--SISTEM-->
                <a class="w-full" href="editSurvey_pilihSoal.php?id_kategori=3">
                    <li class="flex items-center justify-start gap-4 w-full px-5 py-2 bg-[#2D1B6B] font-bold text-white rounded-xl">
                ...
                <!--KURIKULUM-->
                <a class="w-full" href="editSurvey_pilihSoal.php?id_kategori=4">
                    <li class="flex items-center justify-start gap-4 w-full px-5 py-2 bg-[#2D1B6B] font-bold text-white rounded-xl">
                ...
                <!--MAHASISWA-->
                <a class="w-full" href="editSurvey_pilihSoal.php?id_kategori=5">
                    <li class="flex items-center justify-start gap-4 w-full px-5 py-2 bg-[#2D1B6B] font-bold text-white rounded-xl">
                        <img src="../aset/mhs_putih.svg">
                        <div>
                            <h1 class="font-bold text-xl">Penilaian Mahasiswa</h1>
                        </div>
                    </li>
                </a>
            </ul>
