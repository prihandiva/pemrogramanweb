...
<body>
    ...
    <div class="grid grid-cols-5 h-screen">
        ...
        <form action = "submitProses_Wali.php" method= "post">
            ...
            <button class="bg-white text-[#2D1B6B] border-[#2D1B6B] py-2 px-4 rounded-xl border-[#2D1B6B] border-4" type="back"><a href="surveyWali.php"><b>Survey Page</b></a></button>
