    ...
    <div class="grid grid-cols-5 h-screen">
        ...
        <div class="flex justify-end">
            <div class="">
                ...
                <a href="profileWaliEdit.php" class="btn btn-primary fw-bold tombol bg-[#2D1B6B] text-white px-5 py-2" style="border-radius: 10px; width: 100%;"class="mb-2" type='submit'>Simpan</a>
            </div>
            </div>
        </div>
