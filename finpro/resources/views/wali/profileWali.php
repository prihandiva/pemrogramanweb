...
<body>
    ...
    <div class="grid grid-cols-5 h-screen">
        ...
        <div class="flex justify-end">
            <form class="" action="profileWaliEdit.php">
                <div class="form">
                ...
                <!-- <div>
                    <button type="submit" id="edit" class="btn btn-primary fw-bold tombol bg-[#2D1B6B] text-white px-5 py-2" value="edit" style="border-radius: 10px; width: 100%;" href="profileWaliEdit.php">Edit</button>
                </div> -->
                <div class="mt-40 mb-36 ps-80">
                <a href="profileWaliEdit.php" class="btn btn-primary fw-bold tombol bg-[#2D1B6B] text-white px-5 py-2" style="border-radius: 10px; width: 100%;"class="mb-2">Edit</a>
            </div>
</form>
        </div>
        <div class="circle" style="margin-top: 20px; margin-left: 100px;">
            <img src="../aset/lambang-polinema1.png" alt="Placeholder Image" width="250" height="285">
                ...
                <button class="btn btn-primary fw-bold tombol bg-[#2D1B6B] text-white px-5 py-2" style="border-radius: 10px; width: 100%;">WALI</button>
                </div>
        </div>
        </div>
    </div>
